...
function FilterButton({
  ...
  return (
    <motion.button
      ...
      onClick={onClick}
      className={[
        "cursor-pointer inline-flex items-center gap-2 rounded-2xl border px-4 py-2 text-sm font-semibold transition-colors",
        active
          ? "border-blue-200 bg-blue-50 text-blue-700"
          : "border-(--ff-border) bg-(--ff-surface-soft) text-(--ff-text) hover:bg-slate-100",
      ].join(" ")}
    >
      {children}
    </motion.button>
